...
main: {
    ...
    while (my $sam_entry = $sam_reader->get_next()) {
        ...
        if ($span_lend < $gene_bound_left && $span_rend > $gene_bound_right) {
            ...
            if ($junction_coord_token) {
                ...
                $fusion_to_scaffold{$junction_coord_token} = $scaffold;
            }
        }
    ...
    
    {
        ...
        my @column_headers = qw(FusionName LeftGene LeftLocalBreakpoint LeftBreakpoint
        ...
        foreach my $fusion (@fusion_j) {
            ...
            my $scaffold = $fusion_to_scaffold{$fusion};
            
            $tab_writer->write_row( { FusionName => $scaffold,
                                      LeftGene => $LeftGene,
